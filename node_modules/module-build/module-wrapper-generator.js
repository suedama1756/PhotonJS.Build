        ...
        generateFactoryCall:function (module, options) {
            ...
            if (!_system.isNullOrUndefined(module.dependencies)) {
                Object.getOwnPropertyNames(module.dependencies).forEach(function (dependencyName) {
                    var commonJS = module.dependencies[dependencyName].commonJS;
                    if (Array.isArray(commonJS)) {
                        if (isAnonymous(dependencyName)) {
                            anonymousDependencies = anonymousDependencies.concat(commonJS);
                        } else {
                            anonymousDependencies = anonymousDependencies.concat(commonJS.slice(1));
                            dependencies.push(commonJS[0]);
                        }
                    } else if (isAnonymous(dependencyName)) {
                        anonymousDependencies.push(commonJS);
                    } else {
                        dependencies.push(commonJS);
                    }
                });
            }
